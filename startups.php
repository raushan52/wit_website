...
">
    ...
    <title>Startups || WitArist IT Services</title>
    <!-- Stylesheets -->
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="page-title page-title-height" style="background-image:url(images/background/block-chain.png)">
            <div class="auto-container">
                <div class="content  col-12 col-md-7 pl-0" style="margin-top: 5rem;">
                    <h1>Startup Idea?</h1>
                    <p class="sub-title text-white">We love taking baby steps with startups. Being a young team, we work on gut-feelings. Just like Startup does. We, were once a mobile solutions startup.</p>
        ...
        <!--End Page Title-->
        <!-- logo-->
        <section class="news-section-two alternate py-5">
		<div class="auto-container">
			<!-- Sec Title -->
			  <div class="sec-title centered pt-3">
                    <h2>Still wondering what we exactly do for Startups?</h2>
                    <p class="text">Well, we do exactly what is required for any startup to grow. We nurture them with all the necessary ingredients to evolve as a successful business in a longer run.</p>
				...
				<div class="row clearfix">
					...
					<div class="column counter-column col-lg-3 col-md-6 col-sm-12">
						<div class="inner wow fadeInLeft animated" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInLeft;">
							...
							<div class="count-outer count-box counted">
								<span class="count-text" data-speed="3000ms" data-stop="1200">1200</span>+
					...
					<div class="column counter-column col-lg-3 col-md-6 col-sm-12">
						<div class="inner wow fadeInLeft animated" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInLeft;">
							...
							<div class="count-outer count-box counted">
								<span class="count-text" data-speed="2000" data-stop="195">195</span>
					...
					<div class="column counter-column col-lg-3 col-md-6 col-sm-12">
						<div class="inner wow fadeInLeft animated" data-wow-delay="900ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 900ms; animation-name: fadeInLeft;">
							...
							<div class="count-outer count-box counted">
								<span class="count-text" data-speed="1500" data-stop="26">26</span>+
		...
		<div class="auto-container">
			<!-- Sec Title -->
			  <div class="sec-title centered pt-3">
                    ...
                    <p class="text">The definitive lean startup guide: everything you need to know</p>
...
-->
							<h5><a href="blog-single.html">The definitive lean startup guide: everything you need to know</a></h5>
							<p>Let’s face it. Running a startup is risky, and sometimes, in the sequence of day-to-day events you’re likely to suffer..</p>
							<a href="blog-single.html" class="theme-btn btn-style-ten">View more</a>
						</div>
					</div>
				</div>
...
-->
							<h5><a href="blog-single.html">10 ways to earn more customers for your on-demand services</a></h5>
							<p>The on demand service market is ruling the world of mobile app...</p>
							<a href="blog-single.html" class="theme-btn btn-style-ten">View more</a>
						</div>
					</div>
				</div>
...
-->
							<h5><a href="blog-single.html">What is the best time to sell your startup?</a></h5>
							<p>No doubts that all entrepreneurs are risk-takers, however...</p>
							<a href="blog-single.html" class="theme-btn btn-style-ten">View more</a>
						</div>
					</div>
				</div>
